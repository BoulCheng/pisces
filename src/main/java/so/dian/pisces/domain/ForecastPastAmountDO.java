...
public class ForecastPastAmountDO {
    private Integer id;
    ...
    private Float payment_amount_original;
    ...
    public Float getPayment_amount_original() {
        return payment_amount_original;
    }

    public void setPayment_amount_original(Float payment_amount_original) {
        this.payment_amount_original = payment_amount_original;
    }
